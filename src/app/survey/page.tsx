"use client";
import CompleteForm from "@/components/FormRelated/CompleteForm";
import { CompleteFormInputProps } from "@/components/FormRelated/types";
  ...
  return (
    <div>
      ...
      <p className="mb-2">
        ...
        understanding of how artificial intelligence is reshaping the landscape
        of alternative investments. By engaging professionals from diverse roles
      ...
      <p>
        This survey will empower us with a comprehensive understanding of the
        current trends and dynamics surrounding artificial intelligence,
        enabling us to identify untapped opportunities, overcome challenges, and
        establish industry-leading practices. The data we collect will serve as
        a catalyst for groundbreaking research and development, driving the
        future of AI-driven solutions in the alternative investment space and
        providing stakeholders with invaluable guidance for their
        decision-making processes. Your participation in this survey plays a
        vital role in advancing our knowledge and fostering innovation within
        the realm of alternative investments.
      </p>
    </div>
  );
};
...
const inputs: CompleteFormInputProps[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: "Scalability", value: "Scalability", colProps: { span: 12 } },
      {
  ...
  },
  {
    ...
    options: [
      ...
      { label: "Disagree", value: "Disagree", colProps: { span: 12 } },
  ...
  },
  {
    ...
    rules: [
      ({ getFieldValue }) => ({
        validator(_, value) {
          if (!value && getFieldValue("challengeOption").includes("Other")) {
            return Promise.reject(
              new Error('This field is required if "Other" is selected'),
            );
          }
      ...
      ({ getFieldValue }) => ({
        validator(_, value) {
          if (!value && getFieldValue("rpaExploration") === "Yes") {
            return Promise.reject(
              new Error('This field is required if "Yes" is selected'),
            );
          }
          return Promise.resolve();
        },
  ...
  },
  {
    ...
    options: [
      { label: "Not Likely", value: "Not Likely", colProps: { span: 12 } },
      {
  ...
  },
  {
    ...
    options: [
      ...
      { value: "Disagree", label: "Disagree", colProps: { span: 12 } },
